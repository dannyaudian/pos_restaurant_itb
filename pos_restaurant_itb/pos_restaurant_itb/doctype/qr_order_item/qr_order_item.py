...
__created_date__ = '2025-04-06 17:40:10'
...
class QROrderItem(Document):
    """
    QR Order Item Document Class
    ...
    def get_price_list(self) -> Optional[str]:
        """Get price list from parent QR Order"""
        if self.parent:
    ...
    def on_update(self) -> None:
        ...
        if self.has_value_changed("kot_status"):
            ...
            if self.parent:
                parent = frappe.get_doc("QR Order", self.parent)
