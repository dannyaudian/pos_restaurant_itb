...
@frappe.whitelist()
def cancel_pos_order_item(item_name: str, reason: str = "Cancelled manually") -> dict:
    """
    Membatalkan item dalam pesanan POS.
...
def mark_all_served(pos_order_id: str) -> str:
    """
    Menandai semua item dalam pesanan POS sebagai telah dilayani.

    :param pos_order_id: ID dari pesanan POS.
    :return: Pesan yang menunjukkan hasil operasi.
    """
